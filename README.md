...
- `android/` — native Android shell for the Vitr web player, including installable APK build configuration.
...
- `npm run android:build` — build the installable Android debug APK with a local Gradle 8.11.1+ installation.
