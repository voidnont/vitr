...
- `mobile/android/` — native Android source and APK build configuration.
...
- `npm run android:build` — build the installable Android debug APK from `mobile/android/` with a local Gradle 8.11.1+ installation.
